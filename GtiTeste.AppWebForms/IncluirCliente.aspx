<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="IncluirCliente.aspx.cs" Inherits="GtiTeste.AppWebForms.IncluirCliente" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="alert alert-success" id="divSucesso" visible="false" runat="server">
        <strong>
            <asp:Label runat="server" Style="color: green" ID="lblMensagemSucesso" Text="" /></strong>
    </div>
